...
async function analyzeGroup(group, itemNumber, API_KEY) {
  ...
  const prompt = `Look at these clothing images. Create a STRUCTURED eBay title following EXACT format.

DETECTION RULES:
- If you see Roman numerals (I, II, III, IV, V) = Size and brand is OSKA
- Read exact size labels clearly (S, M, L, XL, 34, 36, 38, etc.)
- Pick ONE main color only (not multiple colors)
- Look for care labels for fabric info

TITLE FORMAT - MUST FOLLOW EXACTLY:
"Brand ItemType Womens Size MainColor Material StyleWord"

PERFECT EXAMPLES:
- "Oska Tank Top Womens Size II Cream Linen Minimalist"
- "Oska Dress Womens Size III Navy Cotton Contemporary" 
- "Ganni Blouse Womens Size 38 Pink Silk Romantic"
- "COS Jumper Womens Size M Black Wool Oversized"

COLOR RULES - VERY IMPORTANT:
- Pick ONE main color: Cream, Navy, Black, White, Grey, Pink, Blue, Green, Beige, Brown
- NO compound colors like "Beige Light" or "Light Pink" - just "Beige" or "Pink"
- NO multiple colors - just the dominant single color

ITEM TYPE OPTIONS:
Tank Top, Dress, Blouse, Shirt, Jumper, Cardigan, Trousers, Skirt, Jacket, Coat

STYLE WORDS (pick one only):
Minimalist, Contemporary, Asymmetric, Oversized, Bohemian, Romantic, Structured, Flowing

Respond with ONLY this JSON format:
{
  "title": "Brand ItemType Womens Size MainColor Material StyleWord",
  "brand": "exact brand name or Unknown",
  "item_type": "tank top/dress/blouse/shirt/jumper etc",
  "size": "exact size seen or Various",
  "colour": "single main color only",
  "description": "Professional eBay description with fabric, condition, smoke-free home",
