...
function PointerC({ label }: { label: string }) {
  return (
    <div className='absolute top-1/2 left-full hidden w-fit -translate-y-1/2 items-center gap-5 md:flex'>
      <div className='relative'>
        <div className='h-px w-[6.5rem] bg-[#BFBFC4]' />
        <div className='absolute top-1/2 right-0 size-1 -translate-y-1/2 rotate-45 bg-[#BFBFC4]' />
      </div>
...
export function UserDetails() {
  ...
  return (
    <div className='background relative rounded-lg border border-[#EDEDED] bg-[#F1F1F2] p-4 xl:p-16'>
      <div className='max-w-[25rem] rounded-xl bg-white p-8 shadow-[0_5px_15px_rgba(0,0,0,0.08),0_15px_35px_-5px_rgba(25,28,33,0.2)] ring-1 ring-gray-950/5'>
        <div className='mb-6 flex flex-col items-center gap-2'>
          <div className='relative flex w-full justify-center'>
            ...
            <div className='absolute top-1/2 left-full hidden w-fit -translate-x-2.5 -translate-y-1/2 items-center gap-5 md:flex'>
              <div className='relative'>
                <div className='h-px w-[6.5rem] bg-[#BFBFC4]' />
                <div className='absolute top-1/2 right-0 size-1 -translate-y-1/2 rotate-45 bg-[#BFBFC4]' />
              </div>
